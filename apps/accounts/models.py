...
from apps.constants import BANK_CODES, ACCOUNT_TYPE, TRANSACTION_TYPE, TRANSACTION_METHOD
...
class TransactionHistory(models.Model):
    ...
    transaction_timestamp   = models.DateTimeField('Transaction Timestamp', auto_now_add=True) # 거래 일시
