...
class TransactionHistoryAdmin(admin.ModelAdmin):
    list_display  = ('transaction_id',
        'account', 'transaction_amount', 'post_transaction_amount', 'description', 'transaction_type', 'transaction_method', 'transaction_timestamp',)
    list_filter   = ('transaction_type', 'transaction_method',)
    search_fields = ('description', 'transaction_details',)
